                ...
                <ul class="nav nav-list" id="nav_list">
                    ...
                    <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span
                        ...
                        <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span
                            class="menu-text"> 实验耗材管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home">
                                <a href="javascript:void(0)" name="laboratory_list.do" title="实验室列表" class="iframeurl">
                                    <i class="icon-double-angle-right"></i>实验耗材管理 </a>
                            </li>
                        </ul>
                    </li>
                        <li><a href="#" class="dropdown-toggle"><i class="icon-cogs"></i><span
                                                    class="menu-text"> 实验材料 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="equipment_list.do" title="技术参数管理"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>菌种与质粒</a></li>
                            <li class="home"><a href="javascript:void(0)" name="equipment_dataList.do" title="运行数据管理"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>引物信息</a></li>
                            <li class="home"><a href="javascript:void(0)" name="equipment_dataList2.do" title="电子文档管理"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>抗体信息</a></li>
                            <li class="home"><a href="javascript:void(0)" name="equipment_dataList2.do" title="电子文档管理"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>种子表</a></li>
                            <li class="home"><a href="javascript:void(0)" name="equipment_dataList2.do" title="电子文档管理"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>序列信息</a></li>
                            <li class="home"><a href="javascript:void(0)" name="equipment_dataList2.do" title="电子文档管理"
                                                class="iframeurl"><i class="icon-double-angle-right"></i>文库表</a></li>
                        </ul>
                    </li>
                        </ul>
                    </li>
