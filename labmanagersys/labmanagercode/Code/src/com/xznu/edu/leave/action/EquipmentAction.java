...
//            System.out.println(equipmentService.findid());
     ...
     */
    public String edit() {
        Equipment bean = equipmentService.findid(contructId);
        Pager<Equipment> pagers2 = equipmentService.getList(null);
        ActionContext.getContext().put("pagers2", pagers2);
...
//        Equipment equipment1 = equipmentService.findById(equipment.getcontruct_id());
...
//        }
     ...
     * @return
     */
    public String updateprimedoc() throws IOException {
        PrimeInfo primeinfo=new PrimeInfo();
        primeinfo=primeinfoService.findById(id);
        if (file != null) {
            ActionContext ac = ActionContext.getContext();
            HttpServletRequest request = (HttpServletRequest) ac.get(ServletActionContext.HTTP_REQUEST);
            String root = request.getRealPath("/primerupload");
            ...
            os.close();
            is.close();
            primeinfo.setUrl("\\primerupload\\" + f);
//            equipment.setHt("\\upload\\" + f);
        }
        primeinfoService.updates(primeinfo);
    ...
    public void update() throws IOException {
        ...
        equipment.setCreatetime(adate);
        equipmentService.deletebystring(equipment.getContruct_id());
    ...
    public void download() throws IOException {
        PrimeInfo primeinfo = primeinfoService.findById(id);
        downloadFileName = URLEncoder.encode(primeinfo.getUrl(), "utf-8");
        // 1、得到要下载文件的完整路径
        String path = ServletActionContext.getServletContext().getRealPath(primeinfo.getUrl());
    ...
    public String save() throws IOException {
        ...
        String adate=dateFormat.format(now);
        equipment.setCreatetime(adate);
        String hsql = "select CONTRUCT_ID from t_equipment order by CONTRUCT_ID desc limit 1";
        equipmentService.save(equipment);
        map.put("flag", true);
    ...
    public String primesave() throws  IOException{
        PrimeInfo primeinfo=new PrimeInfo();
        primeinfo.setTitle(equipment.getBuilder_id());
        primeinfo.setDescription(equipment.getRemark());
        Date now = new Date();
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
        String adate=dateFormat.format(now);
    ...
    public void primedelete() throws IOException{
        primeinfoService.delete(id);
        map.put("flag", true);
        map.put("url", "equipment_dataList.do");
        JsonUtils.toJson(map);
    }
...
//        out.close();
    ...
    public void setContructId(String contructId) {
        this.contructId = contructId;
    }
